...
date: 2026-07-03
description: "餐饮系统财务模块的真实需求：员工上传票据自动提取日期、金额、商家。传统 OCR 不行，Gemini Flash 便宜到可以忽略成本，金额准确率 ~98%。附完整实现和踩坑记录。"
tags: ["Gemini", "OCR", "AI应用", "实战", "票据识别"]
---
...
餐厅每月有大量报销票据需要录入：超市采购单、加油票、杂项票据。
